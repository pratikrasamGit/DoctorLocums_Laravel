<p><strong>Last Updated: 01/01/2022.</strong></p>
...
<p>The present terms and conditions (this &quot;<strong>Agreement</strong>&quot; or &quot;<strong>Terms</strong>&quot;) is a legal agreement between you and Nurseify, Inc. (hereinafter <strong>&quot; Nurseify</strong>&quot;), a company duly organized and validly existing, located at PO Box 8354, Houston, Texas 77288.&nbsp; This Agreement annuls and voids all previous agreements.</p>

<p><strong>OVERVIEW</strong></p>

<p>The Site (www.nurseify.app) is operated by Nurseify. Throughout the Site, the terms &quot;<strong>we</strong>&quot;, &quot;<strong>us</strong>&quot; and &quot;<strong>our</strong>&quot; refer to Nurseify. Nurseifyoffers this Site, including all information, tools and services available from this Site to you, the user, conditioned upon your acceptance of all terms, conditions, policies and notices stated here.</p>
...
<p>You may not modify, publish, transmit, reverse engineer, participate in the transfer or sale, create derivative works, or in any way exploit any of the content, in whole or in part, found on the Site. Nurseifycontent is not for resale. Use of the Site does not entitle users to make any unauthorized use of any protected content, and in particular you will not delete or alter any proprietary rights or attribution notices in any content. You will use protected content solely for your personal use, and will make no other use of the content without the express written permission of Nurseify and the copyright owner. You agree that you do not acquire any ownership rights in any protected content. We do not grant you any licenses, express or implied, to the intellectual property of Nurseify or our licensors except as expressly authorized by these Terms.</p>

<p><strong>SECTION 2 - CREATING AN ACCOUNT</strong></p>

<p>Once you create an account with us, you are registered on the Nurseify Site. The terms &quot;member,&quot; &quot;membership,&quot; and &quot;account&quot; all refer to this registration as a member on Nurseify&#39;s Site. If you are merely surfing or browsing through the Site and have not yet created an account, your use of the Site is still subject to this Agreement; if you do not agree to this Agreement, do not use the Site.</p>

<p>When you create an account, you will provide a unique username and email.&nbsp; We will also ask you to create a password.&nbsp; Because any activities that occur under your username or password are your responsibility it is important for you to keep your username and/or password secure. You may not assign or otherwise transfer your account to any other person or entity. You acknowledge that Nurseify is not responsible for third party access to your account that results from theft or misappropriation of your account. Notify us immediately if you believe that someone has used your username, email, or password without your authorization.</p>
...
<p>If anyone knowingly provides any information of a false, untrue, inaccurate or incomplete nature, Nurseify, Inc.&nbsp; will have sufficient grounds and rights to suspend or terminate the member in violation of this aspect of the Agreement, and as such refuse any and all current or future use of Nurseify, Inc. Services, or any portion thereof.</p>

<p><strong>SECTION 3 - CONDUCT</strong></p>

<p>As a user or member of the Site, you herein acknowledge, understand and agree that all information, text, software, data, photographs, music, video, messages, tags or any other content, whether it is publicly or privately posted and/or transmitted, is the expressed sole responsibility of the individual from whom the content originated. In short, this means that you are solely responsible for any and all content posted, uploaded, emailed, transmitted or otherwise made available by way of the Nurseify Services, and as such, we do not guarantee the accuracy, integrity or quality of such content. It is expressly understood that by use of our Services, you may be exposed to content including, but not limited to, any errors or omissions in any content posted, and/or any loss or damage of any kind incurred as a result of the use of any content posted, emailed, transmitted or otherwise made available by Nurseify.</p>

<p>Furthermore, you herein agree not to make use of Nurseify, Inc.&#39;s Services for the purpose of:</p>
...
<p>c) impersonating any individual or entity, including, but not limited to, any Nurseify officials, forum leaders, guides or hosts or falsely stating or otherwise misrepresenting any affiliation with an individual or entity;</p>
...
<p>j) interfering with or disrupting any Nurseify, Inc.Services, servers and/or networks that may be connected or related to our website, including, but not limited to, the use of any device software and/or routine to bypass the robot exclusion headers;</p>
...
<p>Nurseify, Inc. herein reserves the right to pre-screen, refuse and/or delete any content currently available through our Services. In addition, we reserve the right to remove and/or delete any such content that would violate the Terms or which would otherwise be considered offensive to other visitors, users and/or members.</p>

<p>Nurseify, Inc. herein reserves the right to access, preserve and/or disclose member account information and/or content if it is requested to do so by law or in good faith belief that any such action is deemed reasonably necessary for:</p>

<p>a) compliance with any legal process;</p>

<p>b) enforcement of the Terms;</p>
...
<p>e) protecting the rights, property or the personal safety of Nurseify, Inc., its visitors, users and members, including the general public.</p>

<p>Nurseify, Inc. herein reserves the right to include the use of security components that may permit digital information or material to be protected, and that such use of information and/or material is subject to usage guidelines and regulations established by Nurseify, Inc. or any other content providers supplying content services to Nurseify, Inc.. You are hereby prohibited from making any attempt to override or circumvent any of the embedded usage rules in our Services. Furthermore, unauthorized reproduction, publication, distribution, or exhibition of any information or materials supplied by our Services, despite whether done so in whole or in part, is expressly prohibited.</p>

<p><strong>SECTION 4 - GLOBAL USE; EXPORT/IMPORT COMPLIANCE</strong></p>
...
<p><strong>SECTION 5 - SUBMITTED CONTENT</strong></p>

<p>Nurseify, Inc. shall not lay claim to ownership of any content submitted by any visitor, member, or user, nor make such content available for inclusion on our website Services. Therefore, you hereby grant and allow for Nurseify, Inc. the below listed worldwide, royalty-free and non-exclusive licenses, as applicable:</p>

<p>a) The content submitted or made available for inclusion on the publicly accessible areas of Nurseify, Inc.&#39;s Sites, the license provided to permit to use, distribute, reproduce, modify, adapt, publicly perform and/or publicly display said Content on our network Services is for the sole purpose of providing and promoting the specific area to which this content was placed and/or made available for viewing. This license shall be available so long as you are a member of Nurseify, Inc.&#39;s sites, and shall terminate at such time when you elect to discontinue your membership.</p>

<p>b) Photos, audio, video and/or graphics submitted or made available for inclusion on the publicly accessible areas of Nurseify, Inc.&#39;s sites, the license provided to permit to use, distribute, reproduce, modify, adapt, publicly perform and/or publicly display said Content on our network Services are for the sole purpose of providing and promoting the specific area in which this content was placed and/or made available for viewing. This license shall be available so long as you are a member of Nurseify, Inc.&#39;s sites and shall terminate at such time when you elect to discontinue your membership.</p>

<p>c) For any other content submitted or made available for inclusion on the publicly accessible areas of Nurseify, Inc.&#39;s sites, the continuous, binding and completely sub-licensable license which is meant to permit to use, distribute, reproduce, modify, adapt, publish, translate, publicly perform and/or publicly display said content, whether in whole or in part, and the incorporation of any such Content into other works in any arrangement or medium current used or later developed.</p>

<p>Those areas which may be deemed &quot;publicly accessible&quot; areas of Nurseify, Inc.&#39;s Sites are those such areas of our network properties which are meant to be available to the general public, and which would include message boards and groups that are openly available to both users and members. However, those areas which are not open to the public, and thus available to members only, would include our mail system and instant messaging.</p>

<p><strong>CONTRIBUTIONS TO COMPANY WEBSITE</strong></p>

<p>Nurseify, Inc. may provide an area for our user and members to contribute feedback to our website. When you submit ideas, documents, suggestions and/or proposals (&quot;<strong>Contributions</strong>&quot;) to our site, you acknowledge and agree that:</p>

<p>a) your contributions do not contain any type of confidential or proprietary information;</p>

<p>b) Nurseify shall not be liable or under any obligation to ensure or maintain confidentiality, expressed or implied, related to any Contributions;</p>

<p>c) Nurseify shall be entitled to make use of and/or disclose any such Contributions in any such manner as they may see fit;</p>

<p>d) the contributor&#39;s Contributions shall automatically become the sole property of Nurseify; and</p>

<p>e) Nurseify is under no obligation to either compensate or provide any form of reimbursement in any manner or nature.</p>

<p><strong>SECTION 6 - INDEMNITY</strong></p>

<p>All users and/or members agree to insure and hold Nurseify, Inc., our subsidiaries, affiliates, agents, employees, officers, partners and/or licensors blameless or not liable for any claim or demand, which may include, but is not limited to, reasonable attorney fees made by any third party which may arise from any content a&nbsp; member or user of our Site may submit, post, modify, transmit or otherwise make available through our Services, the use of Nurseify Services or your connection with these Services, your violations of the Terms of Service and/or your violation of any such rights of another person.</p>

<p><strong>SECTION 7 - COMMERCIAL REUSE OF SERVICES</strong></p>

<p>The member or user herein agrees not to replicate, duplicate, copy, trade, sell, resell nor exploit for any commercial reason any part, use of, or access to Nurseify&#39;s sites.</p>

<p><strong>SECTION 8 - MODIFICATIONS</strong></p>

<p>Nurseify, Inc.reserves the right at any time it may deem fit, to modify, alter and or discontinue, whether temporarily or permanently, our service, or any part thereof, with or without prior notice. In addition, we shall not be held liable to you or to any third party for any such alteration, modification, suspension and/or discontinuance of our Services, or any part thereof.</p>

<p><strong>SECTION 9 - TERMINATION</strong></p>

<p>As a member of www.nurseify.app, you may cancel or terminate your account, associated email address and/or access to our Services by submitting a cancellation or termination request to .</p>

<p>As a member, you agree that Nurseify, Inc. may, without any prior written notice, immediately suspend, terminate, discontinue and/or limit your account, any email associated with your account, and access to any of our Services. The cause for such termination, discontinuance, suspension and/or limitation of access shall include, but is not limited to:</p>

<p>a) any breach or violation of our Terms or any other incorporated agreement, regulation and/or guideline;</p>
...
<p>g) the nonpayment of any associated fees that may be owed by you in connection with your www.nurseify.app account Services.</p>
...
<p>The termination of your account with www.nurseify.app shall include any and/or all of the following:</p>

<p>a) the removal of any access to all or part of the Services offered within www.nurseify.app;</p>
...
<p><strong>SECTION 10 - LINKS</strong></p>

<p>Either Nurseify, Inc.&nbsp; or any third parties may provide links to other websites and/or resources. Thus, you acknowledge and agree that we are not responsible for the availability of any such external sites or resources, and as such, we do not endorse nor are we responsible or liable for any content, products, advertising or any other materials, on or available from such third-party sites or resources. Furthermore, you acknowledge and agree that Nurseify, Inc.&nbsp; shall not be responsible or liable, directly or indirectly, for any such damage or loss which may be a result of, caused or allegedly to be caused by or in connection with the use of or the reliance on any such content, goods or Services made available on or through any such site or resource.</p>

<p><strong>SECTION 11 - PROPRIETARY RIGHTS</strong></p>

<p>You do hereby acknowledge and agree that Nurseify, Inc.&#39;s Services and any essential software that may be used in connection with our Services (&quot;Software&quot;) shall contain proprietary and confidential material that is protected by applicable intellectual property rights and other laws. Furthermore, you herein acknowledge and agree that any Content which may be contained in any advertisements or information presented by and through our Services or by advertisers is protected by copyrights, trademarks, patents or other proprietary rights and laws. Therefore, except for that which is expressly permitted by applicable law or as authorized by Nurseify, Inc. or such applicable licensor, you agree not to alter, modify, lease, rent, loan, sell, distribute, transmit, broadcast, publicly perform and/or created any plagiaristic works which are based on Nurseify, Inc.&nbsp; Services (e.g. Content or Software), in whole or part.</p>

<p>Nurseify, Inc. hereby grants you a personal, non-transferable and non-exclusive right and/or license to make use of the object code or our Software on a single computer, as long as you do not, and shall not, allow any third party to duplicate, alter, modify, create or plagiarize work from, reverse engineer, reverse assemble or otherwise make an attempt to locate or discern any source code, sell, assign, sublicense, grant a security interest in and/or otherwise transfer any such right in the Software. Furthermore, you do herein agree not to alter or change the Software in any manner, nature or form, and as such, not to use any modified versions of the Software, including and without limitation, for the purpose of obtaining unauthorized access to our Services. Lastly, you also agree not to access or attempt to access our Services through any means other than through the interface which is provided by Nurseify, Inc. for use in accessing our Services.</p>

<p><strong>SECTION 12 - WARRANTY DISCLAIMERS</strong></p>

<p>YOU HEREIN EXPRESSLY ACKNOWLEDGE AND AGREE THAT:</p>

<p>a) THE USE OF NURSEIFY, INC. SERVICES AND SOFTWARE ARE AT THE SOLE RISK BY YOU. OUR SERVICES AND SOFTWARE SHALL BE PROVIDED ON AN &quot;AS IS&quot; AND/OR &quot;AS AVAILABLE&quot; BASIS. NURSEIFY, INC. AND OUR SUBSIDIARIES, AFFILIATES, OFFICERS, EMPLOYEES, AGENTS, PARTNERS AND LICENSORS EXPRESSLY DISCLAIM ANY AND ALL WARRANTIES OF ANY KIND WHETHER EXPRESSED OR IMPLIED, INCLUDING, BUT NOT LIMITED TO ANY IMPLIED WARRANTIES OF TITLE, MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE AND NON-INFRINGEMENT.</p>

<p>b) NURSEIFY, INC. AND OUR SUBSIDIARIES, OFFICERS, EMPLOYEES, AGENTS, PARTNERS AND LICENSORS MAKE NO SUCH WARRANTIES THAT (i) NURSEIFY, INC. SERVICES OR SOFTWARE WILL MEET YOUR REQUIREMENTS; (ii) NURSEIFY, INC.&nbsp; SERVICES OR SOFTWARE SHALL BE UNINTERRUPTED, TIMELY, SECURE OR ERROR-FREE; (iii) THAT SUCH RESULTS WHICH MAY BE OBTAINED FROM THE USE OF THE NURSEIFY, INC.&nbsp; SERVICES OR SOFTWARE WILL BE ACCURATE OR RELIABLE; (iv) QUALITY OF ANY PRODUCTS, SERVICES, ANY INFORMATION OR OTHER MATERIAL WHICH MAY BE PURCHASED OR OBTAINED BY YOU THROUGH OUR SERVICES OR SOFTWARE WILL MEET YOUR EXPECTATIONS; AND (v) THAT ANY SUCH ERRORS CONTAINED IN THE SOFTWARE SHALL BE CORRECTED.</p>

<p>c) ANY INFORMATION OR MATERIAL DOWNLOADED OR OTHERWISE OBTAINED BY WAY OF NURSEIFY, INC. SERVICES OR SOFTWARE SHALL BE ACCESSED BY YOUR SOLE DISCRETION AND SOLE RISK, AND AS SUCH YOU SHALL BE SOLELY RESPONSIBLE FOR AND HEREBY WAIVE ANY AND ALL CLAIMS AND CAUSES OF ACTION WITH RESPECT TO ANY DAMAGE TO YOUR COMPUTER AND/OR INTERNET ACCESS, DOWNLOADING AND/OR DISPLAYING, OR FOR ANY LOSS OF DATA THAT COULD RESULT FROM THE DOWNLOAD OF ANY SUCH INFORMATION OR MATERIAL.</p>

<p>d) NO ADVICE AND/OR INFORMATION, DESPITE WHETHER WRITTEN OR ORAL, THAT MAY BE OBTAINED BY YOU FROM NURSEIFY, INC.&nbsp; OR BY WAY OF OR FROM OUR SERVICES OR SOFTWARE SHALL CREATE ANY WARRANTY NOT EXPRESSLY STATED IN THE TERMS.</p>
...
<p><strong>SECTION 13 - LIMITATION OF LIABILITY</strong></p>

<p>YOU EXPLICITLY ACKNOWLEDGE, UNDERSTAND AND AGREE THAT NURSEIFY, INC. AND OUR SUBSIDIARIES, AFFILIATES, OFFICERS, EMPLOYEES, AGENTS, PARTNERS AND LICENSORS SHALL NOT BE LIABLE TO YOU FOR ANY PUNITIVE, INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL OR EXEMPLARY DAMAGES, INCLUDING, BUT NOT LIMITED TO, DAMAGES WHICH MAY BE RELATED TO THE LOSS OF ANY PROFITS, GOODWILL, USE, DATA AND/OR OTHER INTANGIBLE LOSSES, EVEN THOUGH WE MAY HAVE BEEN ADVISED OF SUCH POSSIBILITY THAT SAID DAMAGES MAY OCCUR, AND RESULT FROM:</p>
...
<p><strong>SECTION 14 - RELEASE</strong></p>

<p>In the event you have a dispute, you agree to release Nurseify, Inc.(and its officers, directors, employees, agents, parent subsidiaries, affiliates, co-branders, partners and any other third parties) from claims, demands and damages (actual and consequential) of every kind and nature, known and unknown, suspected or unsuspected, disclosed and undisclosed, arising out of or in any way connected to such dispute.</p>

<p><strong>SECTION 15 - NOTICE</strong></p>
...
<p><strong>SECTION 16 - INTELLECTUAL PROPERTY RIGHTS</strong></p>

<p>You herein acknowledge, understand and agree that all of the Nurseify, Inc.trademarks, copyright, trade name, service marks, and other Nurseify, Inc.logos and any brand features, and/or product and service names are trademarks and as such, are and shall remain the property of Nurseify, Inc.. You herein agree not to display and/or use in any manner the Nurseify, Inc.logo or marks without obtaining Nurseify, Inc.&#39;s prior written consent.</p>
...
<p>The Nurseify, Inc.&nbsp; agent for notice of claims of copyright or other intellectual property infringement can be contacted as follows:</p>
...
<p>Houston, Texas 77288</p>

<p>Telephone: 2818321485</p>

<p>Email: info@nurseify.app</p>

<p><strong>SECTION 17 - ENTIRE AGREEMENT</strong></p>

<p>This Agreement constitutes the entire agreement between you and Nurseify, Inc.and shall govern the use of our Services, superseding any prior version of this Agreement between you and us with respect to Nurseify, Inc. Services. You may also be subject to additional terms and conditions that may apply when you use or purchase certain other Nurseify, Inc. Services, affiliate Services, third-party content or third-party software.<br />
&nbsp;</p>

<p><strong>SECTION 18 - CHOICE OF LAW AND FORUM</strong></p>

<p>It is at the mutual agreement of both you and Nurseify, Inc. with regard to the Agreement that the relationship between the parties shall be governed by the laws of the state of Texas without regard to its conflict of law provisions and that any and all claims, causes of action and/or disputes, arising out of or relating to the Agreement, or the relationship between you and Nurseify, Inc., shall be filed within the courts having jurisdiction within the County of Harris, Texas or the U.S. District Court located in said state. You and Nurseify, Inc. agree to submit to the jurisdiction of the courts as previously mentioned, and agree to waive any and all objections to the exercise of jurisdiction over the parties by such courts and to venue in such courts.</p>

<p><strong>SECTION 19 - WAIVER AND SEVERABILITY OF TERMS</strong></p>

<p>At any time, should Nurseify, Inc.&nbsp; fail to exercise or enforce any right or provision of the Agreement, such failure shall not constitute a waiver of such right or provision. If any provision of this Agreement is found by a court of competent jurisdiction to be invalid, the parties nevertheless agree that the court should endeavor to give effect to the parties&#39; intentions as reflected in the provision, and the other provisions of the Agreement remain in full force and effect.</p>

<p><strong>SECTION 20 - NO RIGHT OF SURVIVORSHIP NON-TRANSFERABILITY</strong></p>
...
<p><strong>SECTION 21 - STATUTE OF LIMITATIONS</strong></p>

<p>You acknowledge, understand and agree that regardless of any statute or law to the contrary, any claim or action arising out of or related to the use of our Services or the Agreement must be filed within 7 year(s) after said claim or cause of action arose or shall be forever barred.</p>

<p><strong>SECTION 22 - VIOLATIONS</strong></p>

<p>Please report any and all violations of this Agreement to Nurseify, Inc. as follows:</p>
...
<p><strong>SECTION 23 - GOVERNMENT REQUESTS</strong></p>
...
<p><strong>SECTION 24 - FOREIGN ACCESS OF SITE</strong></p>

<p>The Site is controlled, operated and administered by Nurseifyfrom our offices within the USA. If you access the Site from a location outside the USA, you are responsible for compliance with all local laws. You agree that you will not use Nurseify&#39;s content accessed through the Site in any country or in any manner prohibited by any applicable laws, restrictions or regulations.</p>

<p><strong>SECTION 25 - ERRORS, INACCURACIES AND OMISSIONS</strong></p>
