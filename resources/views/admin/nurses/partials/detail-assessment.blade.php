        ...
        <div class="content with-padding">
            ...
            <div class="row">
                ...
                <div class="col-xl-12">
                    ...
                    <a href="{{ route('file.remove',[$nurse->id,$additional_picture->id]) }}">remove</a>
                    @endif
                    @endforeach
                    </div>
                    </div>
                    ...
                    <div class="submit-field">
                        ...
                        @foreach($nurse->nurseAssets->where('filter','additional_files') as $additional_file)
                            ...
                            <div class="attachment-box ripple-effect">
                                <a href="{{ route('file.download',[$nurse->id,$additional_file->id]) }}" target="_blank"><span>{{$additional_file->name}}</span></a>
                                <a href="{{ route('file.remove',[$nurse->id,$additional_file->id]) }}" class="remove-attachment" data-tippy-placement="top" title="Remove"></a>
                            </div>
                            @endif
                        @endforeach
                        </div>
