...
<div class="col-xl-12">
    <div class="dashboard-box">
        ...
        <div class="headline resume-upload">
            ...
            <input class="uploadButton-input" type="file" name="resume" 
            ...
            <a href="{{route('cv.download', [$nurse->id])}}" target="_blank"><i class="icon-line-awesome-file-pdf-o"></i>View Resume </a>
            @endif
            @else
            <a href="{{route('cv.media.download', [$nurse->id])}}" target="_blank"><i class="icon-line-awesome-file-pdf-o"></i>View Resume </a>
            @endif            
            OR <a href="{{route('admin-add-work-history', [$nurse->id])}}">Add Work History <i class="icon-material-outline-add"></i></a></h3>
        </div>
                    ...
                    <table class="basic-table">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td data-label="Column 6"><a href="{{ route('admin-edit-work-history',[$nurse->id,$nuexp->id]) }}" class="icon edit-icon" data-tippy-placement="top" title="Edit"><i class="icon-feather-edit"></i></a></td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-4">
                            <div class="submit-field">
                                ...
                                {{Form::number('experience_as_acute_care_facility', $nurse->experience_as_acute_care_facility, 
                        ...
                        <div class="col-xl-4">
                            <div class="submit-field">
                                ...
                                {{Form::number('experience_as_ambulatory_care_facility', $nurse->experience_as_ambulatory_care_facility, 
    ...
    <div class="dashboard-box margin-top-30">
        ...
        <div class="headline">
            ...
            <a href="{{route('add-credentials',[$nurse->id])}}">Add Credentials <i class="icon-material-outline-add"></i></a></h3>
        </div>
        <div class="content with-padding padding-bottom-0">
                    ...
                    <div class="submit-field">
                        ...
                        <div class="attachments-container margin-top-0 margin-bottom-0">
                           @foreach($nurse->certifications as $certification)
                            ...
                            <a href="{{ route('edit-credentials',[$nurse->id,$certification->id]) }}"><span>{{\App\Providers\AppServiceProvider::keywordTitle($certification->type)}}</span></a>
                                ...
                                <a href="{{ route('credential.remove',[$nurse->id,$certification->id]) }}" class="remove-attachment" data-tippy-placement="top" title="Remove"></a>
                            </div>
                            @endforeach
                        </div>
                    </div>
