...
@endphp
<!-- Dashboard Box -->
{!! Form::open(['action' => ['ProfileController@personalDetailPost',$nurse->id], 'method' => 'POST', 'files' => 'true']) !!}
<div class="row">
<div class="col-xl-12">
                ...
                <div class="col">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-3">
                            <div class="submit-field">
                                <h5>Country</h5>
                                {{Form::select('country', $countries,  $nurse->country, 
                                \App\Providers\AppServiceProvider::fieldAttr($errors->has('country'), 
                                ['class' => 'selectform', 'placeholder' => 'Choose country','id'=>'country-dropdown']))}}
